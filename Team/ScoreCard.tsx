  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.keyStatsContainer}>
        <Text style={styles.keyStatsHeader}>Key Stats</Text>
        <Text style={styles.keyStat}>Partnership: {keyStats.partnership}</Text>
        <Text style={styles.keyStat}>Last Wkt: {keyStats.lastWkt}</Text>
        <Text style={styles.keyStat}>Ovs Left: {keyStats.ovLeft}</Text>
        <Text style={styles.keyStat}>Last 10 overs: {keyStats.last10Overs}</Text>
        <Text style={styles.keyStat}>Toss: {keyStats.toss}</Text>
      </View>

      <View style={styles.commentaryContainer}>
        <Text style={styles.commentaryHeader}>{commentary}</Text>
        <Text style={styles.commentaryText}>Wiaan Mulder [6.0-3-17-3] is back into the attack</Text>
      </View>
      ...
      <View style={styles.overSummaryContainer}>
        <Text style={styles.overSummaryHeader}>{overSummary.runs}</Text>
        <Text style={styles.overSummaryText}>{overSummary.score}</Text>
        <Text style={styles.overSummaryText}>{overSummary.batsmen}</Text>
        <Text style={styles.overSummaryText}>{overSummary.bowler}</Text>
      </View>
